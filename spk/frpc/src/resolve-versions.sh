...
# resolve-versions.sh
#
# Dynamically resolve the LATEST STABLE release tag of frp from GitHub.
# This lets the frpc SPK track upstream releases automatically instead of
...
# Strip any leading 'v' (tags look like v0.71.0).
VERSION="${VERSION#v}"
