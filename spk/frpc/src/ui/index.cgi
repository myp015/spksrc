...
.header { display: flex; align-items: center; justify-content: space-between; padding: 8px 14px; background: #f7f9fc; border: 1px solid #e6e8ec; border-radius: 8px; }
.header h2 { margin: 0; font-size: 18px; }
.gap { height: 12px; background: #f0f1f3; border-radius: 6px; margin: 12px 0; }
