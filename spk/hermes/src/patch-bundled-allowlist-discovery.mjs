...
if (!root) {
  fail('usage: node patch-bundled-allowlist-discovery.mjs <hermes-bundle-dir>');
}
...
const replacement = [
  '\t\tif (entryType !== "directory") continue;',
  '\t\tconst bundledAllowlistRaw = params.origin === "bundled" ? (params.env?.HERMES_BUNDLED_PLUGIN_DIR_ALLOWLIST ?? process.env.HERMES_BUNDLED_PLUGIN_DIR_ALLOWLIST ?? "") : "";',
