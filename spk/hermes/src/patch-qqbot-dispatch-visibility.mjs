...
if (!root) fail('usage: node patch-qqbot-dispatch-visibility.mjs <hermes-bundle-dir>');

const candidates = [
  path.join(root, 'node_modules', '@tencent-connect', 'hermes-qqbot', 'dist', 'src', 'gateway.js'),
