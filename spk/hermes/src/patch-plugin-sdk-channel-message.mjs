...
if (!root) {
  console.error('[patch-plugin-sdk-channel-message] usage: node patch-plugin-sdk-channel-message.mjs <hermes-bundle-dir>');
  process.exit(2);
}
...
// Compatibility bridge for legacy `hermes/plugin-sdk/channel-message` imports.
